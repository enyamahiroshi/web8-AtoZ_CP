...
<link rel="stylesheet" type="text/css" href="<?php echo get_bloginfo('template_directory'); ?>/css/employ2022.css">
...
<div id="breadcrumbs">
	<div class="inner">
		<span><span><a href="<?php echo home_url('/'); ?>">トップページ</a> &gt; <span><a href="<?php echo home_url('/'); ?>employee-training/">法人向け研修</a> &gt; <span><a href="<?php echo home_url('/'); ?>employee-training/achievement/">導入実績</a> &gt; <span class="breadcrumb_last" aria-current="page"><?php the_title(); ?></span></span></span></span></span>
		</div>
</div>
